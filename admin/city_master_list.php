                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    <?php
                                        include('../db_con.php');
                                        $fetch_query = "SELECT * FROM add_city_master";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a type="submit" class="btn btn-primary shadow btn-xs sharp me-1" href="city_master_edit.php?user_id=<?php echo $row['id']; ?>" style="color:white;">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <form method="POST" action="city_master_dlt.php" style="display:inline;">
