                                ...
                                <form method="POST" action="project_update.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="city_name" id="city_name" class="form-control"
                                                value="<?php echo htmlspecialchars($project['city_name']); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="property" id="property" class="form-control">
                                                ...
                                                <option value="Residential Property"
                                                    <?php echo ($project['property'] == 'Residential Property') ? 'selected' : ''; ?>>Residential Property
                                                </option>
                                                <option value="Commercial Property"
                                                    <?php echo ($project['property'] == 'Commercial Property') ? 'selected' : ''; ?>>
                                                    Commercial Property</option>
                                                    <option value="Industrial Property"
                                                    <?php echo ($project['property'] == 'Industrial Property') ? 'selected' : ''; ?>>Industrial Property
                                                </option>
                                                <option value="Agricultural Property"
                                                    <?php echo ($project['property'] == 'Agricultural Property') ? 'selected' : ''; ?>>
                                                    Agricultural Property</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label>Total Area (In Sqft)</label>
                                            <input type="text" name="totalarea" id="totalarea" class="form-control"
                                                value="<?php echo htmlspecialchars($project['totalarea']); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="totalamount" id="totalamount" class="form-control"
                                                value="<?php echo htmlspecialchars($project['totalamount']); ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Address</label>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea name="highlight_text" id="highlight_text" class="form-control"
                                            placeholder="Enter Project Highlight" required><?php echo htmlspecialchars($project['highlight_text']); ?>
                                        </textarea>
                                    </div>
                                    ...
                                    <div class="form-row mt-3">
                                        <div class="form-group col-md-6">
                                            ...
                                            <label>Choose Bottom Slider Images <span class="text-primary">(Resolution:
                                                    600 ×
                                    ...
                                    <button type="submit" name="submit" class="btn btn-primary mt-4 mb-4">Update</button>
