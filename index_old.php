...
<body class="preload-wrapper">
    ...
    <div class="offcanvas offcanvas-start canvas-filter canvas-sidebar" id="sidebarmobile">
        <div class="canvas-wrapper">
            ...
            <!--Script for filtration function-->
            <script>
                        document.addEventListener("DOMContentLoaded", function() {
                        ...
                        function filterProjects(filterType, filterValue) {
                            ...
                            projectCards.forEach(card => {
                                ...
                                // "All" filter logic: Show projects where status, feature_status, or king_status is 1
                                if (
                                    (filterType === "status" && filterValue === "1" && (status === "1" || featureStatus === "1" || kingStatus === "1")) ||
                                    (filterType === "feature_status" && filterValue === "1" && featureStatus === "1") ||
                                    (filterType === "king_status" && filterValue === "1" && kingStatus === "1")
                                ) {
                                    card.style.display = ""; // Show the project
                                } else {
                        ...
                        document.querySelectorAll(".dropdown-menu .select-item").forEach(item => {
                            item.addEventListener("click", function() {
                                ...
                                // Update active class
                                document.querySelectorAll(".dropdown-menu .select-item").forEach(i => i.classList.remove("active"));
                        ...
                        // Apply the default filter when the page loads
                        ...
                        filterProjects(defaultFilterType, defaultFilterValue);  // Apply default filter
                    });
            </script>
            
            <!--script for pagination function-->
            <script>
                document.addEventListener("DOMContentLoaded", function () {
