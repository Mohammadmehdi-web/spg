                    ...
                    <div class="tf-control-sorting d-flex justify-content-end">
                        <div class="tf-dropdown-sort" data-bs-toggle="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="select-item"><span class="text-value-item">Best Project</span></div>
                                <div class="select-item" data-sort-value="a-z"><span
                                        class="text-value-item">Alphabetically, A-Z</span></div>
                                <div class="select-item" data-sort-value="z-a"><span
                                        class="text-value-item">Alphabetically, Z-A</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="tf-row-flex">
                        ...
                        <div class="tf-grid-layout wrapper-shop tf-col-4">
                            <?php
                                ...
                                $sql = "SELECT add_project.year AS year, project_images.image, add_project.pro_tile, add_project.highlight_text, add_project.pro_url, 
                                    ...
                                    add_project.status, add_project.king_status
                                FROM add_project
                                INNER JOIN project_images ON add_project.id = project_images.project_id
                                WHERE add_project.status = 1"; // Active projects only
                            ...
                            if (!in_array($projectId, $displayedProjects)) {
                                $year = $row['year'];
                                $image = $row['image'];
                                $pro_tile = $row['pro_tile'];
                                $highlight_text =$row['highlight_text'];
                                $pro_url = $row['pro_url'];
                                $industry_name = strtolower(str_replace(' ', '_', $row['industry_name']));
                                $pro_category = strtolower(str_replace(' ', '_', $row['pro_category']));
                                $country_name = strtolower(str_replace(' ', '_', $row['country_name']));
                                $status = $row['status'];
                                $king_status = $row['king_status'];

                                $displayedProjects[] = $projectId;
                    ?>
                            <!-- Card product in grid layout -->
                            <div class="card-product grid"
                                data-industry="<?php echo strtolower(str_replace(' ', '_', $row['industry_name'])); ?>"
                                data-category="<?php echo strtolower(str_replace(' ', '_', $row['pro_category'])); ?>"
                                data-country="<?php echo strtolower(str_replace(' ', '_', $row['country_name'])); ?>"
                                data-year="<?php echo $row['year']; ?>" data-availability="In stock"
                                data-brand="Ecomus">
                                <div class="card-product-wrapper">
                                    <a href="project/<?= $pro_url; ?>" class="product-img">
                                        <img class="lazyload img-product"
                                            data-src="project/project_upload/<?= $image; ?>"
                                            src="project/project_upload/<?= $image; ?>" alt="image-product">
                                    </a>
                                    <div class="list-product-btn absolute-2">
                                        <a href="project/<?= $pro_url; ?>"
                                ...
                                <div class="card-product-info">
                                    <a href="project/<?= $pro_url; ?>" class="title link"><?= $pro_tile; ?></a>
                                </div>
                            </div>
                            <?php
                        }
                    ...
                    ?>
                            ...
                            <ul class="wg-pagination tf-pagination-list">
                                ...
                                <li><a href="#" class="pagination-link animate-hover-btn">2</a></li>
                                <li><a href="#" class="pagination-link animate-hover-btn">3</a></li>
                                <li><a href="#" class="pagination-link animate-hover-btn">4</a></li>
                                <li><a href="#" class="pagination-link animate-hover-btn">
...
<!-- Mirrored from themesflat.co/html/ecomus/shop-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Jan 2025 09:38:38 GMT -->
