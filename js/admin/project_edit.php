                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form method="POST" action="project_update.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label>Choose Main Image <span class="text-primary">(Resolution: 600 ×
                                                    900)</span></label>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label>Choose Gallery Images <span class="text-primary">(Resolution:
                                                    1920 × 1080)</span></label>
                                            <p class="maxsize">(Max size: 3.34 MB)</p>
                                            <input type="file" name="photo_gallery[]" id="photo_gallery"
                                                class="form-control file" multiple >
                                        </div>
