                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Project Master List</h4>
                            </div>
                            <hr>
                            <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    <?php
                                        include('../db_con.php');
                                        $fetch_query = "SELECT * FROM add_pro_master";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a type="submit" class="btn btn-primary shadow btn-xs sharp me-1" href="pro_master_edit.php?user_id=<?php echo $row['id']; ?>" style="color:white;">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <form method="POST" action="pro_master_dlt.php" style="display:inline;">
